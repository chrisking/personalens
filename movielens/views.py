...
def get_recommendations(user_id):
    ...
    :return: list of movies to be rendered. or None if there is no active campaign.
    """
    items_to_return = None
    # First check to see if there's a campaign:
    if settings.CAMPAIGN_ARN:
        ...
        # Now switch items_to_return to an array
        items_to_return = []
